...
P15/P16 已由修复提交 `af699c1` 的远端 run `34734838719` 完成七 job 跨平台验收，下一里程碑为 P17 项目级审查。P16 的“真实”指调用实际生成器，输入是公开合成 DOCX；不外推为客户数据或量产交付。详见 [P16 记录](../research/p16-generate-arxml-artifact-bridge-2026-09-12.md)。
